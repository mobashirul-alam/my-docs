...
// Create an array of markers from 0 to 82
...
export const Ruler = () => {
    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        const PAGE_WIDTH = 816; // 8.5 inches * 96 pixels/inch
            ...
            if (container) {
                ...
                if (isDraggingLeft) {
                    const maxLeftPosition =
                        PAGE_WIDTH - rightMargin - MINIMUM_SPACE; // Ensure at least 100px gap
            ...
            >
                ...
                <div className="absolute inset-x-0 bottom-0 h-full">
                    <div className="relative h-full w-[816px]">
                        {markers.map((marker) => {
                            const position = (marker * 816) / 82; // 82 segments for 83 markers
